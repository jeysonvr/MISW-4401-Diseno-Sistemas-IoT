...
float sensorLuminosidad = A0; // Pin LDR
int l;
...
void loop()
{
  ...
  // Valores luminosidad
  float vLum = analogRead(sensorLuminosidad);
  l = ((long)(1024-vLum)*A*10)/((long)B*Rc*vLum);
