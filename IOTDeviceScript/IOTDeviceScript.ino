...
const char ssid[] = "RAGNAR"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "Bmanga2306"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "3.81.252.12"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
const char MQTT_TOPIC_PUB[] = "Colombia/Santander/Bucaramanga/" USER "/out"; //TODO Reemplace el valor por el tópico de publicación que le corresponde.
// El tópico de suscripción debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/in
const char MQTT_TOPIC_SUB[] = "Colombia/Santander/Bucaramanga/" USER "/in"; //TODO Reemplace el valor por el tópico de suscripción que le corresponde.
